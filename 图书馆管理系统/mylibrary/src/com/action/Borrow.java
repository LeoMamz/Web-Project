	...
	/******************************************************************************************/
	    public ActionForward execute(ActionMapping mapping, ActionForm form,
	        ...
	        if(action==null||"".equals(action)){
	            ...
	            return bookborrow(mapping,form,request,response);  //借阅书籍
	        }else if("bookrenew".equals(action)){
	            return bookrenew(mapping,form,request,response);  //续借书籍
	        }else if("bookback".equals(action)){
	            return bookback(mapping,form,request,response);  //归还书籍
	        }else if("Bremind".equals(action)){
	            return bremind(mapping,form,request,response);  //归还信息查询
    ...
    private ActionForward bookborrow(ActionMapping mapping, ActionForm form,
        ...
        if (key != null && !key.equals("")) {
            ...
            if (bookForm!=null){
                ...
                request.setAttribute("error", "没有该图书或该图书库存不足!");
                return mapping.findForward("error");
            }
        }
