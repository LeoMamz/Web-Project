...
public class BookDAO {
	...
	public Collection query(String strif) {
		...
		try {
			while (rs.next()) {
				...
				bookForm.setTotal(rs.getInt(14));
				bookForm.setStock(rs.getInt(15));
				bookForm.setBookcaseName(rs.getString(16));
				bookForm.setPublishing(rs.getString(17));
				bookForm.setTypeName(rs.getString(18));
	...
	public int insert(BookForm bookForm) {
		...
		try {
			if (rs.next()) {
				...
				sql = "Insert into tb_bookinfo (barcode,bookname,typeid,author,translator,isbn,price,page,bookcase,inTime,operator,total,stock) values('"
						+ bookForm.getBarcode()
						+ "','"
						+ bookForm.getBookName()
						+ "',"
	...
	public int update(BookForm bookForm) {
		String sql = "Update tb_bookinfo set typeid=" + bookForm.getTypeId()
				...
				+ ",stock=" + bookForm.getStock()
				+ ",bookcase=" + bookForm.getBookcaseid()
