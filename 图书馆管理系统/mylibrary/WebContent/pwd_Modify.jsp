...
<table width="778"  border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
    <td height="510" valign="top" style="padding:5px;"><table width="98%" height="487"  border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td height="22" valign="top" class="STYLE6">当前位置：更改密码-&gt;&gt;&gt;</td>
      </tr>
      <tr>
 ...
 <table width="100%"  border="0" cellspacing="0" cellpadding="0">
  ...
  <tr align="center">
    <td width="28%" align="left" style="padding:5px;" class="STYLE11">管理员名称：</td>
    <td width="72%" align="left">
      <input name="name" type="text" id="name" value="<%=managerForm.getName()%>" readonly="yes" size="30">    </td>
    <tr>
    <td align="left" style="padding:5px;" class="STYLE11">原密码：</td>
    ...
    <tr>
      <td align="left" style="padding:5px;" class="STYLE11">新密码：</td>
      <td align="left"><input name="pwd" type="password" id="pwd" size="30"></td>
    </tr>
    <tr>
      <td align="left" style="padding:5px;" class="STYLE11">确认新密码：</td>
