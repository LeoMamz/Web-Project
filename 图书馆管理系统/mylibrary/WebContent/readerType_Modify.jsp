...
<table width="292" height="175" border="0" cellpadding="0" cellspacing="0" background="Images/book1.png">
 ...
 <input name="id" type="hidden" size="50" value="<%=readerTypeForm.getId()%>"> 
  ...
  <tr>
    <td width="28%" align="center"  class="STYLE1">类型名称：      </td>
    <td width="72%"><input name="name" type="text" size="28" value="<%=readerTypeForm.getName()%>">
      </td>
  </tr>
  <tr>
    <td align="center" class="STYLE1">可借数量：</td>
    <td  class="STYLE1"><input name="number" type="text" size="23" value="<%=readerTypeForm.getNumber()%>">
      (本)</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
