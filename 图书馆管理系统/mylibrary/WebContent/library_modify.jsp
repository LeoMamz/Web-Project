...
<table width="778"  border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
    <td valign="top" bgcolor="#333333"><table width="99%" height="510" background="Images/star.png" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFA" class="tableBorder_gray">
  <tr>
    <td height="510" valign="top" style="padding:5px;"><table width="98%" height="487"  border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td height="22" valign="top" class="STYLE6">当前位置：系统设置-&gt; 图书馆信息-&gt;&gt;&gt;</td>
      </tr>
      <tr>
...
%>
  <table width="65%"  border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolordark="#D2E3E6" bordercolorlight="#FFFFFF">
  <tr align="center">
    <td width="25%" align="left" style="padding:5px;" class="STYLE11">图书馆名称：</td>
    <td width="75%" align="left">
      <input name="libraryname" type="text" id="libraryname" value="<%=libraryname%>" size="30">
    
    </td>
    <tr>
    <td align="left" style="padding:5px;" class="STYLE11">馆长：</td>
    <td align="left"><input name="curator" type="text" id="curator" size="30" value="<%=curator%>" ></td>
    </tr>
    <tr>
      <td align="left" style="padding:5px;" class="STYLE11">联系电话：</td>
      <td align="left"><input name="tel" type="text" id="tel" size="30" value="<%=tel%>"></td>
    </tr>
    <tr>
      <td align="left" style="padding:5px;" class="STYLE11">联系地址：</td>
      <td align="left"><input name="address" type="text" id="address" size="30" value="<%=address%>"></td>
    </tr>
    <tr>
      <td align="left" style="padding:5px;" class="STYLE11">联系邮箱：</td>
      <td align="left"><input name="email" type="text" id="email" size="30" value="<%=email%>"></td>
    </tr>
    <tr>
      <td align="left" style="padding:5px;" class="STYLE11">图书馆网址：</td>
      <td align="left"><input name="url" type="text" id="url" size="30" value="<%=url%>"></td>
    </tr>
    <tr>
      <td align="left" style="padding:5px;" class="STYLE11">建馆时间：</td>
      <td align="left"><input name="createDate" type="text" id="createDate" size="30" value="<%=createTime%>">
      (日期格式：2007-11-22)</td>
    </tr>
    <tr>
      <td height="84" align="left" style="padding:5px;" class="STYLE11">图书馆简介：</td>
