...
<table width="778"  border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
    <td height="510" valign="top" style="padding:5px;"><table width="98%" height="487"  border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td height="22" valign="top" class="STYLE6">当前位置：读者管理 &gt; 读者档案管理 &gt; 修改读者信息 &gt;&gt;&gt;</td>
      </tr>
      <tr>
...
<%  int ID=readerForm.getId().intValue();
  ...
  %>
	...
	<form name="form1" method="post" action="reader.do?action=readerModify">
      ...
      <tr>
        <td width="173" align="center" class="STYLE11">姓&nbsp;&nbsp;&nbsp;&nbsp;名：</td>
      ...
      <tr>
        <td width="173" align="center" class="STYLE11">性&nbsp;&nbsp;&nbsp;&nbsp;别：</td>
      ...
      <tr>
        <td align="center" class="STYLE11">借书证号：</td>
        <td><input name="barcode" type="text" id="barcode" value="<%=barcode%>" readonly="yes"></td>
      </tr>
      <tr>
        <td align="center" class="STYLE11">读者类型：</td>
        <td>
...
<%}%> 
      ...
      <tr>
        <td align="center" class="STYLE11">证件号码：</td>
        <td><input name="paperNO" type="text" id="paperNO" value="<%=paperNO%>"> 
          * </td>
      </tr>
      <tr>
        <td align="center" class="STYLE11">电&nbsp;&nbsp;&nbsp;&nbsp;话：</td>
        <td><input name="tel" type="text" id="tel" value="<%=tel%>"></td>
      </tr>
      <tr>
        <td align="center" class="STYLE11">Email：</td>
