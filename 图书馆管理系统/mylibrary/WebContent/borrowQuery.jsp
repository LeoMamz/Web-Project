...
<table width="778"  border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
    <td height="510" valign="top" style="padding:5px;"><table width="98%" height="487"  border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td height="22" valign="top" class="STYLE6">当前位置：系统查询-&gt; 图书借阅查询-&gt;&gt;&gt;</td>
      </tr>
      <tr>
		...
		<form name="myform" method="post" action="borrow.do?action=borrowQuery">
          <table width="98%" height="67"  border="0" cellpadding="0" cellspacing="0" bgcolor="#E3F4F7" class="tableBorder_gray">
            <tr>
              ...
              <td class="STYLE11" height="29" bgcolor="#333333"><input name="flag" type="checkbox" class="noborder" value="a" checked>
                请选择查询依据：
                <select name="f" class="wenbenkuang" id="f">
                  <option value="barcode">图书编号</option>
                  <option value="bookname">图书名称</option>
                  <option value="readerbarcode">借书证号</option>
            ...
            <tr>
              <td height="26" bgcolor="#333333" class="STYLE11">
...
%>
  ...
  <tr align="center" bgcolor="#333333">
    <td height=45 width="11%" class="STYLE1">图书编号</td>
    <td width="20%" class="STYLE1">图书名称</td>
    <td width="13%" class="STYLE1">借书证号</td>
    <td width="13%" class="STYLE1">读者名称</td>
    <td width="15%" class="STYLE1">借阅时间</td>
    <td width="15%" class="STYLE1">应还时间</td>
    <td width="13%" class="STYLE1">是否归还</td>
  </tr>
<%
  while(it.hasNext()){
  ...
  <tr bgcolor="#333333">
    ...
    <td class="STYLE5" style="padding:5px;"><%=bookname%></td>
    <td class="STYLE5" style="padding:5px;">&nbsp;<%=readerbar%></td>
    <td class="STYLE5" style="padding:5px;">&nbsp;<%=readername%></td>
    <td class="STYLE5" style="padding:5px;">&nbsp;<%=borrowTime%></td>
    <td class="STYLE5" style="padding:5px;">&nbsp;<%=backTime%></td>
    <td class="STYLE5" align="center" style="padding:5px;">&nbsp;<%=ifbackstr%></td>
  </tr>
<%
  }
}
