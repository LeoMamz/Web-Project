...
<td width="16%" align="right">
  ...
  <tr align="center" bgcolor="#333333">
    <td width="70%" class="STYLE1">书架名称</td>
...
<%
  ...
  <tr bgcolor="#333333">
    ...
    <td class="STYLE5" align="center"><a href="#" onClick="window.open('bookCase.do?action=bookCaseModifyQuery&ID=<%=ID%>','','width=292,height=175')">修改</a></td>
    <td class="STYLE5" align="center"><a href="bookCase.do?action=bookCaseDel&ID=<%=ID%>">删除</a></td>
  </tr>
<%
  }
}
