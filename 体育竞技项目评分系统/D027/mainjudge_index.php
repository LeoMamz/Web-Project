...
if(!isset($sql_grade)) $sql_grade = "SELECT * FROM program NATURAL JOIN item where present = 1 ORDER BY group_id desc, present_order,program_id, con_unit";
                ...
                <div class="panel panel-default">
                    ...
                    <div>
                        <table class="table table-bordered  mb-15">
                            <thead>
                            <tr>
                                <form action="mainjudge_index.php" method="post" class="fr input-group">
...
//                                        }
                                    ...
                                    echo " alert($message);\r\n";
                                    echo "location.href='mainjudge_index.php';";
                                    echo "</script>";
                                    exit;
                                }
