...
//        exit;
              ...
              if (file_exists("kejian/" . $file_name))
              {
                  echo "<script language=\"JavaScript\">\r\n";
...
//            echo $_FILES["file"]["name"] . " 文件已经存在。 ";
              ...
              else
              {
                  ...
                  $cid = "0100";
                  $file_path = "kejian/" . $file_name;
                  $file_path_utf8 = "kejian/" . $file_name_utf8;
                  $t=time();
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                      <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="online-tab">
                          ...
                          mysqli_query($con , "set names utf8");
                          $query="SELECT file_path, file_name, upload_time, file_id FROM coursefile WHERE cid=\"0100\" AND state!=\"t\" AND TYPE=\"kj\" AND delete_type=0";
                        ...
                        <div class=\"x_panel\">
                          <div class=\"x_title\">
                            ...
                            <div class=\"x_content collapse\" >";
                              ...
                              <p><a href=\"tea_ppt.php?id=$file_id\" name='delete_file'><i class=\"glyphicon glyphicon-trash\" id='delete_file' ></i><strong> 删除</strong></a></p>
                                  ";
                                      echo "
                            <br />
                            </div>
                ...
                ";
                          ...
                          <form action="tea_ppt.php" class="dropzone" id="form_hw3" method="post" enctype="multipart/form-data">
