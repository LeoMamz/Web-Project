...
<html lang="en">
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST" || isset($_POST["file"])){
      ...
      if (!strcmp($extension,"mp4")
          || !strcmp($extension,"avi")
          || !strcmp($extension,"mov")
          || !strcmp($extension,"3gp")
          || !strcmp($extension,"ogg")
          || !strcmp($extension,"wmv")
          || !strcmp($extension,"flv"))
      {
...
//            echo $_FILES["file"]["name"] . " 文件已经存在。 ";
              ...
              else
              {
                  ...
                  $file_name = iconv("UTF-8","gb2312", $_FILES["file"]["name"]);
                  move_uploaded_file($_FILES["file"]["tmp_name"], "videos/" . $file_name);

                  $cid = "0100";
                  $file_path = "videos/" . $file_name;
                  $file_path_utf8 = "videos/" . $file_name_utf8;
                  $t=time();
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div class="row">
                        ...
                        mysqli_query($con , "set names utf8");
                        $query="SELECT file_path, file_name, upload_time, file_id, uploader FROM coursefile WHERE cid=\"0100\" AND state!=\"t\" AND TYPE=\"sp\" AND delete_type=0";
                          ...
                          <div class=\"image view view-first\">
                            ...
                            <div class=\"mask no-caption\">
                              <div class=\"tools tools-bottom\">
                                <a href=\"tea_video1_play.php?id=".$row["file_id"]."\"><i class=\"fa fa-play-circle-o\"></i></a>
                                <a href=\"".$row["file_path"]."\"><i class=\"fa fa-download\"></i></a>
                                <a href=\"tea_video.php?id=".$row["file_id"]."\"><i class=\"glyphicon glyphicon-trash\"></i></a>                                
                              </div>
                            </div>
                          </div>
                          <div class=\"caption\">
                    ...
                    <h4>将文件拖入提交框中或点击提交框上传文件。</h4>
                    <form action="tea_video.php" class="dropzone" id="form_hw3">
