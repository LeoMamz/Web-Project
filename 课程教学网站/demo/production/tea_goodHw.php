...
if ($_SERVER["REQUEST_METHOD"] == "GET" && isset($_GET["id"])){
    ...
    if($re){
        ...
        echo " alert(\"删除文件成功！\");\r\n";
        echo "location.href='tea_goodHw.php';";
        echo "</script>";
    }else {
        echo "<script language=\"JavaScript\">\r\n";
        echo " alert(\"删除文件失败！\");\r\n";
...
//        exit;
            ...
            if (file_exists("youxiuzuoye/" . $file_name))
            {
                echo "<script language=\"JavaScript\">\r\n";
...
//            echo $_FILES["file"]["name"] . " 文件已经存在。 ";
            ...
            else
            {
                ...
                $file_name = iconv("UTF-8","gb2312", $_FILES["file"]["name"]);
                move_uploaded_file($_FILES["file"]["tmp_name"], "youxiuzuoye/" . $file_name);

                $cid = "0100";
                $file_path = "youxiuzuoye/" . $file_name;
                $file_path_utf8 = "youxiuzuoye/" . $file_name_utf8;
                $t=time();
                ...
                echo "location.href='tea_goodHw.php';";
                echo "</script>";
//            echo "文件存储在: " . "youxiuzuoye/" . $_FILES["file"]["name"];
            }
        }
    }
    else
        ...
        <div class="right_col" role="main">
            <div class="">
                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="online-tab">
                                    ...
                                    mysqli_query($con , "set names utf8");
                                    $query="SELECT file_path, file_name, upload_time, file_id FROM coursefile WHERE cid=\"0100\" AND state!=\"t\" AND TYPE=\"yxzy\" AND delete_type=0";
                        ...
                        <div class=\"x_panel\">
                          <div class=\"x_title\">
                            ...
                            <div class=\"x_content collapse\">";
                              ...
                              <p><a href=\"tea_goodHw.php?id=$file_id\" name='delete_file'><i class=\"glyphicon glyphicon-trash\" id='delete_file' ></i><strong> 删除</strong></a></p>
                                  ";
                                                echo "
                            <br />
                            </div>
                ...
                ";
                                    ...
                                    $con->close();
                                    ?>
                                    <form action="tea_goodHw.php" class="dropzone" id="form_hw3" method="post" enctype="multipart/form-data">
