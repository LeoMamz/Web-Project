              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="images/black_glasses.jpg" alt="">茅则冬
                  ...
                  <?php
                        ...
                        if(isset($_POST["release_note"])){
                            if(empty($_POST["contents"])){
                                ...
                                $_POST["contents"] = "";
                                echo "<script>location.href='stu_notepad.php'</script>";
                      ...
                      <div class="col-md-12 col-sm-12 col-xs-12">
                        <form class="form-horizontal form-label-left input_mask" id="forum_post" method="post" action="tea_notepad.php">
