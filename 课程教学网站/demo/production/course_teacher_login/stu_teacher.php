        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="loginout.php" class="site_title"><i class="fa fa-cloud"></i> <span>软件工程教学</span></a>
            </div>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <?php
                      ...
                      $query="SELECT * FROM myuser inner join courseteacher on myuser.uid=courseteacher.tid";
                      $result_teacher=mysqli_query($con,$query);   //查询记录
                      while($teacher=mysqli_fetch_array($result_teacher)){
                        $tname=$teacher['uname'];
                        $teacher_json=$teacher['introduction'];
                        $teacher_info=json_decode($teacher_json,1);   //编译json字符串

                        //提取数据
                        $ta=$teacher_info['ta'];
                        $teachStyle=$teacher_info['teachStyle'];
                        $achievement=$teacher_info['achievement'];
                        $books=$teacher_info['books'];
                        $honour=$teacher_info['honour'];
                        $contact=$teacher_info['contact'];
