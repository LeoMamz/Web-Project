...
<html lang="en">
  ...
  <head>
    ...
    <link href="js/video-js-7.4.1/video-js.css" rel="stylesheet">
  </head>
  <?php
  session_start();
  ...
  <body class="nav-md">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                  ...
                  if ($_SERVER["REQUEST_METHOD"] == "GET" && isset($_GET["id"])) {
                      ...
                      $query = "SELECT file_path, file_name, upload_time, file_id, uploader FROM coursefile WHERE cid=\"0100\" AND state!=\"t\" AND TYPE=\"yp\" AND delete_type=0 and file_id = \"$id\"";
                    ...
                    <div class=\"col-md-12 col-sm-12 col-xs-12\">
                                    ";
                                  if(!strcmp($houzhui, "mp4"))
                                      echo "<audio src=\"".$row["file_path"]."\" controls=\"controls\" loop=\"loop\" autoplay=\"autoplay\">亲 您的浏览器不支持html5的audio标签</audio>";
                                  else echo "                                       
                                        </div>
                  </div>
                                    ";
                              ...
                              echo " alert(\"音频不存在！\");\r\n";
                              echo "location.href='stu_audio.php';";
                              echo "</script>";
                          }
                      }
                  }
    ...
    <script src="js/video-js-7.4.1/video.js/dist/video.js"></script>
  </body>
</html>