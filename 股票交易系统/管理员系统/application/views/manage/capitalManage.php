...
<html lang="en">
    ...
    <body>
                    ...
                    <div class="content">
                        ...
                        <div class="module">
                            <div class="module-head">
                                <h3>Capital Account Management - Capital Management</h3>
                            </div>
                            <div class="module-body">
                                    ...
                                    <form class="form-horizontal row-fluid" method="post">
                                        ...
                                        <div class="control-group">
                                            <label class="control-label">Opeartion Type</label>
                                            <div class="controls">
                                                <label class="radio inline">
                                                    <input type="radio" name="optionsRadios" id="optionsRadios1" value="Deposit" checked="checked">
                                                    Deposit
                                                </label> 
                                                <label class="radio inline">
                                                    <input type="radio" name="optionsRadios" id="optionsRadios2" value="Withdraw">
                                                    Withdraw
                                                </label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                            <label class="control-label" for="id">资金账户</label>
                                            <div class="controls">
                                                <input type="text" id="id" placeholder="资金账户" class="span8">
                                            </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" id="amount" placeholder="Amount" class="span8">
                                            </div>
                                        </div>

                                        <div class="control-group">
                                            <div class="controls">
                                                <button type="submit" class="btn" id="submit_Cap">Submit</button>
                                            </div>
                                        </div>
                                    </form>
                            </div>
        ...
        <script src="<?php echo base_url() ?>/static/js/capM.js" type="text/javascript"></script>
