...
<html lang="en">
    ...
    <body>
                    ...
                    <div class="content">
                        ...
                        <div class="module">
                            <div class="module-head">
                                <h3>Securities Account Management - Report Account</h3>
                            </div>
                            <div class="module-body">
                                    ...
                                    <form class="form-horizontal row-fluid" method="post">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <label class="radio inline">
                                                    <input type="radio" name="optionsRadios" id="optionsRadios7" value="Natural Person">
                                                    Natural Person
                                                </label> 
                                                <label class="radio inline">
                                                    <input type="radio" name="optionsRadios" id="optionsRadios8" value="Legal person" checked="checked">
                                                    Legal person
                                                </label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                            <label class="control-label" for="basicinput2">法人注册登记号码</label>
                                            <div class="controls">
                                        ...
                                        <div class="control-group">
                                            <label class="control-label" for="basicinput3">法定代表人ID. Num</label>
                                            <div class="controls">
                                        ...
                                        <div class="control-group">
                                            <div class="controls">
                                                <button type="submit" class="btn" id="submit_Sec2">Submit</button>
                                            </div>
                                        </div>
                                    </form>
                            </div>
        ...
        <script src="<?php echo base_url() ?>/static/js/reportAcc.js" type="text/javascript"></script>
