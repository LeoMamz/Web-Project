                    ...
                    <div class="content">
                        ...
                        <div class="module">
                            <div class="module-head">
                                <h3>Securities Account Management - Destruct Account</h3>
                            </div>
                            <div class="module-body">
                                    ...
                                    <form class="form-horizontal row-fluid" method="post">
                                        ...
                                        <div class="control-group">
                                            <label class="control-label" for="basicinput2">证券账号</label>
                                            <div class="controls">
                                        ...
                                        <div class="control-group">
                                            <label class="control-label" for="basicinput3">法人注册登记号码</label>
                                            <div class="controls">
