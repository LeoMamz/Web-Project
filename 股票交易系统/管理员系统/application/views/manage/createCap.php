...
<html lang="en">
    ...
    <body>
        ...
        <div class="wrapper">
            <div class="container">
                <div class="row">
                    ...
                    <div class="content">
                        ...
                        <div class="module">
                            <div class="module-head">
                                <h3>Capital Account Management - Open Account</h3>
                            </div>
                            <div class="module-body">
                                    ...
                                    <form class="form-horizontal row-fluid" method="post">
                                        ...
                                        <div class="control-group">
                                            <label class="control-label" for="sec_id">证券账户</label>
                                            <div class="controls">
                                                <input type="text" id="sec_id" placeholder="Type something here..." class="span8">
                                            </div>
                                        </div>

                                        <div class="control-group">
                                            <label class="control-label" for="identity_id">ID. Number</label>
                                            <div class="controls">
                                                <input type="text" id="identity_id" placeholder="Type something here..." class="span8">
                                            </div>
                                        </div>
                    ...
                    <div id="dialog" title="Please confirm the contents of the form">
        ...
        <script src="<?php echo base_url() ?>/static/js/jszdlp.js" type="text/javascript"></script>
