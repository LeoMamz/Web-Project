...
<html lang="en">
    ...
    <body>
                    ...
                    <div class="content">
                        ...
                        <div class="module">
                            <div class="module-head">
                                <h3>Capital Account Management - Change password</h3>
                            </div>
                            <div class="module-body">
                                    ...
                                    <form class="form-horizontal row-fluid" method="post">
                                        ...
                                        <div class="control-group">
                                            <label class="control-label" for="basicinput">资金账户</label>
                                            <div class="controls">
                                                <input type="text" id="basicinput" placeholder="资金账户" class="span8">
                                            </div>
                                        </div>
                                        
                                        <div class="control-group">
                                            <label class="control-label" for="basicinput1">Present Password</label>
                                            <div class="controls">
                                                <input type="password" id="basicinput1" placeholder="Present Password" class="span8">
                                            </div>
                                        </div>

                                        <div class="control-group">
                                            <label class="control-label" for="basicinput2">New Password</label>
                                            <div class="controls">
                                                <input type="password" id="basicinput2" placeholder="New Password" class="span8">
                                            </div>
                                        </div>
        ...
        <script src="<?php echo base_url() ?>/static/js/changePassword.js" type="text/javascript"></script>
