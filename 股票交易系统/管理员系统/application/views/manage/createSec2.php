        ...
        <div class="wrapper">
            <div class="container">
                <div class="row">
                        ...
                        <div class="module">
                            ...
                            <div class="module-body">
                                    ...
                                    <form class="form-horizontal row-fluid" method="post" >
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <label class="radio inline">
                                                    <input type="radio" name="optionsRadios3" id="optionsRadios7" value="Natural Person">
                                                    Natural Person
                                                </label> 
                                                <label class="radio inline">
                                                    <input type="radio" name="optionsRadios3" id="optionsRadios8" value="Legal person" checked="checked">
                                                    Legal person
                                                </label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                            <label class="control-label" for="basicinput9">法人注册登记号码</label>
                                            <div class="controls">
                                                <input type="text" id="basicinput9" placeholder="Type something here..." class="span8">
                                            </div>
                                        </div>

                                        <div class="control-group">
                                            <label class="control-label" for="basicinput10">营业执照号码</label>
                                            <div class="controls">
                                                <input type="text" id="basicinput10" placeholder="Type something here..." class="span8">
                                            </div>
                                        </div>

                                        <div class="control-group">
                                            <label class="control-label" for="basicinput11">法定代表人name</label>
                                            <div class="controls">
                                                <input type="text" id="basicinput11" placeholder="Type something here..." class="span8">
                                            </div>
                                        </div>

                                        <div class="control-group">
                                            <label class="control-label" for="basicinput13">法定代表人ID. Num</label>
                                            <div class="controls">
                                                <input type="text" id="basicinput13" placeholder="Type something here..." class="span8">
                                            </div>
                                        </div>

                                        <div class="control-group">
                                            <label class="control-label" for="basicinput14">法人Name</label>
                                            <div class="controls">
                                                <input type="text" id="basicinput14" placeholder="Type something here..." class="span8">
                                            </div>
                                        </div>

                                        <div class="control-group">
                                            <label class="control-label" for="basicinput15">法人Tel</label>
                                            <div class="controls">
                                                <input type="text" id="basicinput15" placeholder="Type something here..." class="span8">
                                            </div>
                                        </div>

                                        <div class="control-group">
                                            <label class="control-label" for="basicinput16">法人Add.</label>
                                            <div class="controls">
                                                <input type="text" id="basicinput16" placeholder="Type something here..." class="span8">
                                            </div>
                                        </div>

                                        <div class="control-group">
                                            <label class="control-label" for="basicinput17">授权人Name</label>
                                            <div class="controls">
                                                <input type="text" id="basicinput17" placeholder="Type something here..." class="span8">
                                            </div>
                                        </div>

                                        <div class="control-group">
                                            <label class="control-label" for="basicinput18">授权人ID. Num</label>
                                            <div class="controls">
                                                <input type="text" id="basicinput18" placeholder="Type something here..." class="span8">
                                            </div>
                                        </div>

                                        <div class="control-group">
                                            <label class="control-label" for="basicinput19">授权人Tel</label>
                                            <div class="controls">
                                                <input type="text" id="basicinput19" placeholder="Type something here..." class="span8">
                                            </div>
                                        </div>

                                        <div class="control-group">
                                            <label class="control-label" for="basicinput20">授权人Add.</label>
                                            <div class="controls">
                                                <input type="text" id="basicinput20" placeholder="Type something here..." class="span8">
                                            </div>
                                        </div>
                    ...
                    <div id="dialog_Sec2" title="Please confirm the contents of the form">
