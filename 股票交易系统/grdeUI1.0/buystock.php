    ...
    <div class="content-wrap">
        <header class="top-hd">
            ...
            <div class="hd-rt">
                <ul>
                    <li>
                        <a><i class="icon-user"></i>用户: <?php $user = $_COOKIE['user']; echo $user ?></a>
                    </li>
                    <li>
                        <a><i class="icon-bell-alt"></i>系统消息</a>
                    </li>
                    <li>
                        <a href="updatepw.html"><i class="icon-random"></i>修改密码</a>
                    </li>
                    <li>
        ...
        <main class="main-cont content mCustomScrollbar">
            <div class="page-wrap">
                ...
                <form action="http://localhost:63342/grdeUI1.0/buy.php" method="Post">
                ...
                <div class="form-group-col-2">
                    ...
                    <div class="form-cont">
                        <input type="number" placeholder="默认参考价" class="form-control form-boxed" name="stock_price" style="width:300px;">
                    </div>
                </div>
                <div class="form-group-col-2">
                    <div class="form-label">购买数量：</div>
                    <div class="form-cont">
                        <input type="tel" placeholder="必须为整数" class="form-control form-boxed" name="stock_number" style="width:300px;">
                    </div>
                </div>
                <div class="form-group-col-2">
