	...
	<div class="content-wrap">
		<header class="top-hd">
			...
			<div class="hd-rt">
				<ul>
					<li>
						<a><i class="icon-user"></i>用户:<em>xxx</em></a>
					</li>
					<li>
                                ...
                                <table class="table table-bordered table-striped table-hover">
                                    ...
                                    for($j = $daxiao; $j > 0; $j--){
                                        ...
                                        if(isset($_SESSION[$size]) && $_SESSION[$size][7] == 0){
                                            $a1 = $_SESSION[$size][0];$a2 = $_SESSION[$size][1];$a3 = $_SESSION[$size][2];$a4 = $_SESSION[$size][3];$a5 = $_SESSION[$size][4];$a6 = $_SESSION[$size][5];$a7 = $_SESSION[$size][6];
                                            echo "<form action='updANDdel.php' method='post'>";
                                            echo "<tr class=\'cen\' align='center'>";
                                            echo "<td style='background:#ff2f4c'>" .$a1."</td>";
                                            if(isset($_SESSION[$size][8]) && $_SESSION[$size][8] == 1) echo "<td style='background:#ff2f4c'>" .$a2."</td>";
                                            else echo "<td>" .$a2."</td>";
                                            if(isset($_SESSION[$size][9]) && $_SESSION[$size][9] == 1) echo "<td style='background:#ff2f4c'>" .$a3."</td>";
                                            else echo "<td>" .$a3."</td>";
                                            if(isset($_SESSION[$size][10]) && $_SESSION[$size][10] == 1) echo "<td style='background:#ff2f4c'>" .$a4."</td>";
                                            else echo "<td>" .$a4."</td>";
                                            if(isset($_SESSION[$size][11]) && $_SESSION[$size][11] == 1) echo "<td style='background:#ff2f4c'>" .$a5."</td>";
                                            else echo "<td>" .$a5."</td>";
                                            if(isset($_SESSION[$size][12]) && $_SESSION[$size][12] == 1) echo "<td style='background:#ff2f4c'>" .$a6."</td>";
                                            else echo "<td>" .$a6."</td>";
                                            if(isset($_SESSION[$size][13]) && $_SESSION[$size][13] == 1) echo "<td style='background:#ff2f4c'>" .$a7."</td>";
                                            else echo "<td>" .$a7."</td>";
                                            echo "<td>程序</td>";
                                            echo '<td>';
				...
				<div class="form-group-col-2">
					...
					<div class="form-cont">
						...
						<span class>%</span>
                                                                ...
                                                                <div class="form-group-col-2">
					<div class="form-label">5分钟涨幅超</div>
					<div class="form-cont">
						<input name="5minup" type="number" placeholder="" class="form-control form-boxed" style="width:300px;">
						<span class>%</span>
					</div>
				</div>
                                                                <div class="form-group-col-2">
					<div class="form-label">5分钟跌幅超</div>
					<div class="form-cont">
						<input name="5mindown" type="number" placeholder="" class="form-control form-boxed" style="width:300px;">
						<span class>%</span>
					</div>
				</div>
