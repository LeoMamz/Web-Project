                            ...
                            <div class="tab-cont" style="display: block;">
                                <form action="updANDdel.php" method="get">
                                    ...
                                    <div class="form-group-col-2">
                                        ...
                                        <div class="form-cont">
                                            <input name="5minup" type="number" placeholder=<?php $p = $_SESSION['upd']; echo $_SESSION[$p][5];?> class="form-control form-boxed" style="width:300px;">
                                            <span class>%</span>
                                        </div>
                                    </div>
                                    <div class="form-group-col-2">
                                        ...
                                        <div class="form-cont">
                                            <input name="5mindown" type="number" placeholder=<?php $p = $_SESSION['upd']; echo $_SESSION[$p][6];?> class="form-control form-boxed" style="width:300px;">
                                            <span class>%</span>
                                        </div>
                                    </div>
